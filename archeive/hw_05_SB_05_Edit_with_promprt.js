...
function delete_person_and_kids2(arr, id) {
  ...
  arr_kids_of_parent.forEach((v) => {
    delete_person_and_kids2(arr, v.id);
  });
  // console.log(`delete`);
  // console.log(arr.indexOf(find_index_in_arr_object(arr, "id", id)));
  let idx = find_index_in_arr_object(arr, "id", id);
  arr.splice(idx, 1);
}
