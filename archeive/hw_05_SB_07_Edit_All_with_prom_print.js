...
function choose_action() {
  ...
  !check_if_valid_number(action_kind) && choose_action();
...
// delete_person_and_kids2(person_data_base, "111111111");
// console.log("DDD");

// console.table(per  son_data_base);
...
function find_person_by_text_or_id_and_print() {
  ...
  switch (choose_filed_kind) {
    case 1:
      let id_to_search = get_string("char to look for");
      ...
      if (arr_person_includes_text != "") {
        ...
        console.log(`no persons  name includes: ${id_to_search}`);
      }
      break;
    case 2:
      let str_to_search = get_id("exact ID to search", false);
      ...
      if (id_exist != false) {
        ...
        console.log(`no persons  id : ${str_to_search}`);
      }
      break;
    default:
  }
...
function print_single_person(p) {
  let inx_person_in_arr = find_index_in_arr_object(person_data_base, "id", p);

  person_data_base[inx_person_in_arr].print();
}
// print_single_person("111111111");
...
// console.log("NUM");
// console.log(check_valid_age("FFF"));
// console.log(check_valid_age("12"));
// console.log(check_valid_age("188"));
